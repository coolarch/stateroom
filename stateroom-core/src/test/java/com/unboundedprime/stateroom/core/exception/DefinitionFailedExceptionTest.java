/*
 * DefinitionFailedExceptionTest.java
 *
...
/** Test of the DefinitionFailedException class. */
public class DefinitionFailedExceptionTest {
	...
	/** Test of the default constructor in the DefinitionFailedException class. */
	@Test
	public void testConstructionNoArgs() {
		System.out.println("testConstructionNoArgs");
		
		// Create an instance
		final DefinitionFailedException instance = new DefinitionFailedException();
		
		// Assert true, because if we got this far, nothing blew up
		assertTrue(true);
	}
	
	/** Test of the message text constructor in the DefinitionFailedException class. */
	@Test
	public void testConstructionOnlyMessage() {
		System.out.println("testConstructionOnlyMessage");
		
		// Create an instance
		final DefinitionFailedException instance = new DefinitionFailedException(this._expectedMessageResult);
	...
	public void testConstructionMessageAndThrowable() {
		...
		// Create an instance
		final DefinitionFailedException instance = new DefinitionFailedException(this._expectedMessageResult, this._expectedThrowable);
		// Get the message from the exception instance
		final String messageResult = instance.getMessage();
	...
	public void testConstructionOnlyThrowable() {
		...
		// Create an instance
		final DefinitionFailedException instance = new DefinitionFailedException(this._expectedThrowable);
		// Get the cause from the exception instance
		final Throwable throwableResult = instance.getCause();
