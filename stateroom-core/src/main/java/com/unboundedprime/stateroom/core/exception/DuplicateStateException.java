...
/**
 * Exception to indicate that an duplicate state was attempted to be added.
 */
public class DuplicateStateException extends AbstractStateroomException {
	
	/**
	 * Serialization version id.
	 */
	private static final long serialVersionUID = 4414497073794067207L;
	 ...
	 */
	public DuplicateStateException(final String message) {
		super(message);
	}
	 ...
	 */
	public DuplicateStateException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause Throwable that caused this exception to be thrown
	 */
	public DuplicateStateException(final Throwable cause) {
		super(cause);
	}
}
