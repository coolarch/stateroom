...
/**
 * Exception to indicate that an invalid context was detected.
 */
public class InvalidContextException extends AbstractStateroomException {
	
	/**
	 * Serialization version id.
	 */
	private static final long serialVersionUID = -7828021440786732731L;
