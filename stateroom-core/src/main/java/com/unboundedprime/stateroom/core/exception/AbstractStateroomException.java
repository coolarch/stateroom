/*
 * AbstractStateroomException.java
 *
...
/**
 * Base exception for all exceptions that are specific to the Stateroom framework.
 */
public abstract class AbstractStateroomException extends Exception {
	
	/**
	 * Constructs a new instance with the message and throwable as null.
	 */
	public AbstractStateroomException() {
		super();
	}
	 ...
	 */
	public AbstractStateroomException(final String message) {
		super(message);
	}
	 ...
	 */
	public AbstractStateroomException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause Throwable that caused this exception to be thrown
	 */
	public AbstractStateroomException(final Throwable cause) {
		super(cause);
	}
}
