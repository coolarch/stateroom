...
/**
 * Exception to indicate that an unknown state was referenced.
 */
public class UnknownStateException extends AbstractStateroomException {
	
	/**
	 * Serialization version id.
	 */
	private static final long serialVersionUID = 7215480289657252413L;
